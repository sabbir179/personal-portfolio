          ...
          <div id="tabs" className={classes.root}>
            ...
            <TabPanel value={value} index={0}>
              <h3>Full Stack Web Developer</h3>
                  ...
                  <ul>
                      ...
                      <li>Leaded and co-ordinate multidisciplinary teams to develop Web site and mobile app graphics, content, capacity and interactivity
</li>
            ...
            <TabPanel value={value} index={1}>
              <h3>Web designer and developer</h3>
                  ...
                  <ul>
                      <li>Planned website development, converting mockups into usable web presence with HTML, JavaScript, Wordpress and JSON coding..</li>
                      <li>Provided front-end website development using WordPress, and other editing software..</li>
                      <li>Consulted with clients to develop and document Web site requirements.</li>
                      <li>Prepared mock-ups and storyboards</li>
